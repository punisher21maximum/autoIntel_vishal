...
<section class="bg-white"><div class="col-lg-12"> <img src="wip.gif"><br/><p> <font color="#008000" size="28">We will be updating this page soon..</font> </p></div>
</section>
...
<a href="https://twitter.com/AutointellS"><i class="fa fa-2x  fa-twitter
 text-white mb-3 sr-icons"> | </i></a><a href="https://www.linkedin.com/in/sandeep-shroff/"><i class="fa fa-2x fa-linkedin text-white mb-3 sr-icons"></i></a></div>
            <div class="col-md-4 text-white "><br /><br /><div ><a href="index.php" class="text-white">HOME</a><br /><a href="about.html" class="text-white">ABOUT</a><br /><a href="services.html" class="text-white">SERVICES</a><br /><a href="projects.html" class="text-white">SUCCESS STORIES</a><br /><a href="playlists.html" class="text-white">RESOURCES</a><br /><a href="contact.php" class="text-white">CONTACT</a><br /></div></div><div class="col-lg-4"> <i class="fa fa-phone fa-2x mb-3 sr-contact"></i>
